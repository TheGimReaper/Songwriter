...
We are making(or trying to make) a song writing program :D It will allow the user to add notes, and other fun stuff. 
The user can choose the duration of the notes, the key of the piece, the volume of each layer of music, etc. Also, the user will be able to play back the music.
